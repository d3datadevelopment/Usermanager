[{include file="headitem.tpl" title="D3_USERMANAGER_REQU"|oxmultilangassign}]
...
<form name="myedit" id="myedit" action="[{$oViewConf->getSelfLink()}]" method="post">
    ...
    <table style="border: none; width:98%;">
        ...
        [{if $missingRequValuesActions}]
            <tr>
                <td style="vertical-align: top;" class="edittext" colspan="2">
                    <div class="extension_error">[{oxmultilang ident="D3_USERMANAGER_ERROR_MISSINGREQUREQUIREMENTVALUES"}]</div>
                </td>
            </tr>
        [{/if}]
        ...
        <tr>
            <td style="vertical-align:top;" class="edittext">
                ...
                <details>
                    ...
                    [{oxmultilang ident="d3tbclusermanager_items_requ_desc"}]
                </details>
