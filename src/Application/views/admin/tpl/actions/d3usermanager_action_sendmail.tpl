[{block name="usermanager_admin_action_sendmail"}]
    <dl class="[{$blActionRestriction}]">
        ...
        <dd style="margin-left: 30%;">
            [{if $oView->isEditMode()}]
                [{block name="usermanager_admin_action_sendmail_editor"}]
                    ...
                    <label for="FromModuleId" style="position: absolute; left: -2000px">[{oxmultilang ident="D3_USERMANAGER_ACTION_MAILSEND"}]</label>
                    ...
                    <label for="ToMailInput" style="position: absolute; left: -2000px">[{oxmultilang ident="D3_USERMANAGER_ACTION_MAILSEND"}]</label>
                ...
                [{/block}]
            [{else}]
                [{block name="usermanager_admin_action_sendmail_viewer"}]
                    [{oxmultilang ident="D3_USERMANAGER_ACTION_MAILSEND_FROM1"}]<br>
