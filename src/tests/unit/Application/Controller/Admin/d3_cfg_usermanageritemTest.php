...
class d3_cfg_usermanageritemTest extends d3UsermanagerUnitTestCase
{
    /** @var d3_cfg_usermanageritem */
    ...
    /**
     * @covers \D3\Usermanager\Application\Controller\Admin\d3_cfg_usermanageritem::render
     * @test
