...
class requirementOrderMaxSumTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManagerTotalNetSum()
    {
        ...
        $oManager->setValue('blCheckMaxOrderSum_status', true);
        $oManager->setValue('sCheckMaxOrderSumType', 'oxtotalnetsum');
        $oManager->setValue('sCheckMaxOrderSumValue', '19');
    ...
    public function getConfiguredManagerTotalBrutSum()
    {
        ...
        $oManager->setValue('blCheckMaxOrderSum_status', true);
        $oManager->setValue('sCheckMaxOrderSumType', 'oxtotalbrutsum');
        $oManager->setValue('sCheckMaxOrderSumValue', '80');
    ...
    public function getConfiguredManagerTotalOrderSum()
    {
        ...
        $oManager->setValue('blCheckMaxOrderSum_status', true);
        $oManager->setValue('sCheckMaxOrderSumType', 'oxtotalordersum');
        $oManager->setValue('sCheckMaxOrderSumValue', '155');
    ...
    public function getConfiguredManagerDelCostSum()
    {
        ...
        $oManager->setValue('blCheckMaxOrderSum_status', true);
        $oManager->setValue('sCheckMaxOrderSumType', 'oxdelcost');
        $oManager->setValue('sCheckMaxOrderSumValue', '170');
    ...
    public function getConfiguredManagerPayCostSum()
    {
        ...
        $oManager->setValue('blCheckMaxOrderSum_status', true);
        $oManager->setValue('sCheckMaxOrderSumType', 'oxpaycost');
        $oManager->setValue('sCheckMaxOrderSumValue', '290');
