...
class requirementHasNoticelistTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManagerSet()
    {
        ...
        $oManager->setValue('blCheckNoticeList_status', true);
        $oManager->setValue('sCheckNoticeListType', 'exist');
    ...
    public function getConfiguredManagernotset()
    {
        ...
        $oManager->setValue('blCheckNoticeList_status', true);
        $oManager->setValue('sCheckNoticeListType', 'notexist');
