...
class requirementHasBirthdayTest extends d3RequirementIntegrationTestCase
{
    ...
    public function createTestData()
    {
        ...
        $this->createUser(
            ...
            array(
                'oxcompany' => __CLASS__,
                'oxbirthdate'   => date('Y-m-d', strtotime('-40 year -1day', time()))
            )
        );
    ...
    public function getConfiguredManager()
    {
        ...
        $oManager->setValue('blCheckHasBirthday_status', true);
