...
class requirementUserbasketFromTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManager()
    {
        ...
        $oManager->setValue('blCheckUserBasketFrom_status', true);
        $oManager->setValue('sUserBasketFromValue', date('Y-m-d', strtotime(date('Y-m-d') . ' -1 year')));
