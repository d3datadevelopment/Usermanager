...
class requirementInGroupFilterTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManagerSingle()
    {
        ...
        $oManager->setValue('aCustInGroupId', array('sGroupId1Pass'));
    ...
    public function getConfiguredManagerMulti()
    {
        ...
        $oManager->setValue('blCheckInGroup_status', true);
        $oManager->setValue('aCustInGroupId', array('sGroupId1Pass', 'sGroupId2Pass'));
