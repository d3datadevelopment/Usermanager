...
class requirementUserbasketToTest extends d3RequirementIntegrationTestCase
{
    ...
    public function createTestData()
    {
        ...
        $this->createBaseModelObject(
            ...
            array(
                ...
                'oxtitle'     => 'savedbasket',
                'oxupdate'     => strtotime(date('Y-m-d') . ' -2 year')
            )
        );
        ...
        $this->createBaseModelObject(
            ...
            array(
                ...
                'oxtitle'     => 'savedbasket',
                'oxupdate'     => strtotime(date('Y-m-d') . ' -1 year - 1 minute')
            )
        );
    ...
    public function getConfiguredManager()
    {
        ...
        $oManager->setValue('blCheckUserBasketTo_status', true);
        $oManager->setValue('sUserBasketToValue', date('Y-m-d', strtotime(date('Y-m-d') . ' -1 year')));
