...
class requirementActiveFilterTest extends d3RequirementIntegrationTestCase
{
     ...
     * @throws Exception
     */
    public function getConfiguredManagerActive()
    {
        $oManager = $this->getManagerMock($this->sManagerId);

        $oManager->setValue('blCheckActiveUser_status', true);
        $oManager->setValue('sCheckActiveUserType', 'set');
     ...
     * @throws Exception
     */
    public function getConfiguredManagerNotActive()
    {
        $oManager = $this->getManagerMock($this->sManagerId);

        $oManager->setValue('blCheckActiveUser_status', true);
        $oManager->setValue('sCheckActiveUserType', 'notset');
