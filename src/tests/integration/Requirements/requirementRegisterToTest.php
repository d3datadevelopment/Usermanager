...
class requirementRegisterToTest extends d3RequirementIntegrationTestCase
{
    ...
    public function createTestData()
    {
        ...
        $this->createUser(
            ...
            array(
                'oxcompany' => __CLASS__,
                'oxregister'    => date('Y-m-d H:i:s', strtotime(date('Y-m-d H:i:s') . ' -2 year'))
            )
        );
        ...
        $this->createUser(
            ...
            array(
                'oxcompany' => __CLASS__,
                'oxregister'    => date('Y-m-d H:i:s', strtotime(date('Y-m-d H:i:s') . ' -1 year - 1 minute'))
            )
        );
    ...
    public function getConfiguredManager()
    {
        ...
        $oManager->setValue('blCheckRegisterUserTo_status', true);
        $oManager->setValue('sRegisterUserToValue', date('Y-m-d H:i:s', strtotime(date('Y-m-d H:i:s') . ' -1 year')));
