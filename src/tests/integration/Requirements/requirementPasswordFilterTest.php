...
class requirementPasswordFilterTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManagerSet()
    {
        ...
        $oManager->setValue('blCheckPasswordUser_status', true);
        $oManager->setValue('sCheckPasswordUserType', 'set');
    ...
    public function getConfiguredManagerNotSet()
    {
        ...
        $oManager->setValue('blCheckPasswordUser_status', true);
        $oManager->setValue('sCheckPasswordUserType', 'notset');
