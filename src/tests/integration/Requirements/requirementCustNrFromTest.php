...
class requirementCustNrFromTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManager()
    {
        ...
        $oManager->setValue('blCheckFromUserNr_status', true);
        $oManager->setValue('sFromUserNrValue', '5432');
