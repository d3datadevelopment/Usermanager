...
class requirementDelAddrFilterTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManagerSet()
    {
        ...
        $oManager->setValue('blCheckDeliveryAddress_status', true);
        $oManager->setValue('sCheckDeliveryAddressType', 'set');
    ...
    public function getConfiguredManagernotset()
    {
        ...
        $oManager->setValue('blCheckDeliveryAddress_status', true);
        $oManager->setValue('sCheckDeliveryAddressType', 'notset');
