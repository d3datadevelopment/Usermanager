...
class requirementOrderMaxCountTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManagerSingle()
    {
        ...
        $oManager->setValue('blCheckMaxOrderCount_status', true);
        $oManager->setValue('sCheckMaxOrderCountValue', '1');
    ...
    public function getConfiguredManagerMulti()
    {
        ...
        $oManager->setValue('blCheckMaxOrderCount_status', true);
        $oManager->setValue('sCheckMaxOrderCountValue', '2');
