...
class requirementHasWishlistTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManagerSet()
    {
        ...
        $oManager->setValue('blCheckWishList_status', true);
        $oManager->setValue('sCheckWishListType', 'exist');
    ...
    public function getConfiguredManagernotset()
    {
        ...
        $oManager->setValue('blCheckWishList_status', true);
        $oManager->setValue('sCheckWishListType', 'notexist');
