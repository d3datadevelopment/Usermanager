...
class requirementBoniFilterTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManagerLess()
    {
        ...
        $oManager->setValue('blCheckBoni_status', true);
        $oManager->setValue('sBoniType', 'less');
        $oManager->setValue('sBoniValue', '50');
    ...
    public function getConfiguredManagerHigher()
    {
        ...
        $oManager->setValue('blCheckBoni_status', true);
        $oManager->setValue('sBoniType', 'higher');
        $oManager->setValue('sBoniValue', '50');
