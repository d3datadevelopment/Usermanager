...
class requirementBirthdateToTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManager()
    {
        ...
        $oManager->setValue('blCheckBirthdateUserTo_status', true);
        $oManager->setValue('sBirthdateUserToValue', '12.05.1980');
