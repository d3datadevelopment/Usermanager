...
class requirementInvCompanyFilterTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManagerSet()
    {
        ...
        $oManager->setValue('blCheckInvCompany_status', true);
        $oManager->setValue('sCheckInvCompanyType', 'set');
    ...
    public function getConfiguredManagernotset()
    {
        ...
        $oManager->setValue('blCheckInvCompany_status', true);
        $oManager->setValue('sCheckInvCompanyType', 'notset');
