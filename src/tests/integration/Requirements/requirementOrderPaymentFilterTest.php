...
class requirementOrderPaymentFilterTest extends d3RequirementIntegrationTestCase
{
    ...
    public function createTestData()
    {
        ...
        $this->createOrder(
            ...
            array(
                ...
                'oxorderdate'   => '2018-01-01 00:00:00',
                'oxbillcompany' => __CLASS__,
                'oxpaymenttype' => 'testFailedPayType',
            )
        );
        ...
        foreach ($this->aPayIdList as $sId) {
            $this->createBaseModelObject('oxpayments', $sId);
        }
    }
    ...
    public function getConfiguredManagerSingle()
    {
        ...
        $oManager->setValue('blCheckOrderPayment_status', true);
        $oManager->setValue('aOrderPaymentId', ['testPayType']);
    ...
    public function getConfiguredManagerMulti()
    {
        ...
        $oManager->setValue('blCheckOrderPayment_status', true);
        $oManager->setValue('aOrderPaymentId', ['testPayType', 'testFailedPayType']);
