...
class requirementInvZipFilterTest extends d3RequirementIntegrationTestCase
{
    ...
    public function getConfiguredManager()
    {
        ...
        $oManager->setValue('sInvZipRangeFromValue', '09382');
        $oManager->setValue('sInvZipRangeToValue', '09384');
